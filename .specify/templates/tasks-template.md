...
**Tests**: Test tasks are REQUIRED for every user story. Define tests first and
confirm they fail before implementation tasks begin.
...
- [ ] TXXX [P] Expand unit/integration/contract coverage in tests/
- [ ] TXXX Security hardening
- [ ] TXXX Validate compatibility/migration notes for breaking changes
- [ ] TXXX Verify observability coverage (logs, metrics, alerts, rollback)
